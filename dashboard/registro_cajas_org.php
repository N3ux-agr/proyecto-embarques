...
<div class="container">
    ...
    $consulta = "SELECT tipo_caja FROM bd_empaque.caja_racimo_org"; // Cambiada la tabla en la consulta
...
$(document).on("click", ".btnEditar", function(){
    ...
    console.log("Tipo de caja a editar:", tipo_caja); // Agregamos este mensaje de consola para verificar el valor capturado
    $("#tipo_caja").val(tipo_caja);
    opcion = 2; // Editar
    console.log("Opción:", opcion); // Agregamos este mensaje de consola para verificar la opción
    $("#modalCRUD").modal("show");
});
    ...
    $(document).on("click", ".btnBorrar", function(){    
        ...
        if(respuesta){
            $.ajax({
                url: "bd/crud_cajas_racimo_org.php", // Cambiado el nombre del archivo PHP
                type: "POST",
...
$("#formTiposCaja").submit(function(e){
    ...
    $.ajax({
        url: "bd/crud_cajas_racimo_org.php", // Cambiado el nombre del archivo PHP
        type: "POST",
        data: {tipo_caja: tipo_caja, opcion: opcion},
        success: function(data){  
            if(opcion == 1){
                tablaTiposCaja.row.add([tipo_caja]).draw();
            } else {
                // Corregir esta parte para que actualice la fila modificada
