...
<div class="container">
    ...
    <h1>Registro de Tarea De la Línea Racimo</h1>
<div class="row">
    <div class="col-lg-12 text-center"> 
        <input type="hidden" name="linea" value="Línea Racimo"> <!-- Cambiado a un valor oculto predefinido -->
    </div>
</div>
    ...
    <table class="registro-tarea-table">
        ...
        <tbody>
            ...
            $sql_tipos_cajas = "SELECT DISTINCT tipo_caja FROM caja_racimo"; // Cambiado a caja_bola
