<?php
// Incluye el archivo de sesión para verificar si el usuario ha iniciado sesión
include 'sesion.php';

// Verifica si el usuario ha iniciado sesión
if (!isset($_SESSION['usuario'])) {
    // Si no ha iniciado sesión, redirige a la página de inicio de sesión
    header("Location: http://10.36.1.17/Proyecto%20empaque/dashboard/sesion.php");
    exit(); // Termina el script para evitar que se cargue el resto de la página
}
