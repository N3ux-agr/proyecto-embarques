                    ...
                    <table id="tablaPersonas" class="table table-striped table-bordered table-condensed" style="width:100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td> <!-- Nueva columna QR -->
                                    <button class="btn btn-info btnQR" onclick="accionQR('<?php echo $dat['num_empleado']; ?>')">Tarea/Asistencia</button>
                                </td>
                            </tr>
                            <?php
                                }
...
<script>
    function accionQR(numEmpleado) {
        window.open("registrar_tarea_asistencia.php?num_empleado=" + numEmpleado, '_blank');
    }
</script> 
